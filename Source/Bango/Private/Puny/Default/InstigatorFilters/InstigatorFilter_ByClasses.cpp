#include "Puny/Default/InstigatorFilters/InstigatorFilter_ByClasses.h"

bool UPunyInstigatorFilter_ByClasses::IsValidInstigator_Implementation(UObject* Instigator)
{
